        ...
        <div className='section' id='about'>
          ...
          <div className='generalwrapper'>
            <div className='normal-text'>
              ...
              <p>My interest in software and technology goes back to my adolescence when I created blogs online to keep track of my homework. And when I hacked my videogame consoles, so that I could play as many videogames as possible.</p>
