        ...
        <div className='main-title'>
          <div  className='title'> 
            ...
            <div className='icons'>
              ...
              <a target='_blank' rel='noreferrer' href='mailto:williamalvarez672@gmail.com'>
                <img width='50px' src='https://upload.wikimedia.org/wikipedia/commons/7/7e/Gmail_icon_%282020%29.svg'></img>
              </a></div>
          </div>
        </div>
        <div className='section' id='about'>
          ...
          <div className='generalwrapper'>
            <div className='normal-text'>
              ...
              <p>My interest in software and technology goes back to my teenhood when I created blogs online to keep track of my homework. As well as pirate my videogame consoles, finding new ways to play as many videogames as possible.</p>
